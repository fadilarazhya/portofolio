  ...
  return (
    <section
      ...
      <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0">
        <div className="py-8 lg:px-12 lg:py-16">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
          <div className="shrink-0 max-w-md lg:max-w-lg mx-auto overflow-hidden rounded-md bg-cover bg-[url('/img/obm.jpg)')]">
            <div className="bg-teal-700 bg-opacity-25 rounded-md hover:bg-opacity-0 h-auto">
              <img
          ...
          <div className="mt-6 sm:mt-8 lg:mt-0">
            ...
            <div className="flex space-y-8 space-x-4">
              {/*Figma Start */}
              <div
                data-tooltip-target="tooltip-top-figma"
              ...
              {/*React Start */}
              <div
                data-tooltip-target="tooltip-top-react"
                data-tooltip-placement="top">
                <svg
              ...
              {/*Typescript Start */}
              <div
                data-tooltip-target="tooltip-top-typescript"
                data-tooltip-placement="top">
                <svg
                  className="w-6 h-6 sm:w-8 sm:h-8"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {/*Tailwind Start */}
              <div
                data-tooltip-target="tooltip-top-tailwind"
                data-tooltip-placement="top">
                <svg
                  className="tailwind w-6 h-6 sm:w-8 sm:h-8"
                  xmlns="http://www.w3.org/2000/svg"
              ...
              {/*Express Start */}
              <div
                data-tooltip-target="tooltip-top-express"
                data-tooltip-placement="top">
                <svg
                  className="w-6 h-6 sm:w-8 sm:h-8 dark:filter dark:drop-shadow-[0_0_1px_rgba(255,255,255,0.8)]"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 128 128">
              ...
              {/*MYSQL Start */}
              <div
                data-tooltip-target="tooltip-top-mysql"
                data-tooltip-placement="top">
                <svg
                  className="w-6 h-6 sm:w-8 sm:h-8"
                  xmlns="http://www.w3.org/2000/svg"
